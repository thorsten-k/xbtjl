...
public class BenEncoder
{
    ...
    private void encode(ByteArrayOutputStream baos, Object object) throws IOException
    {
        if (object instanceof String || object instanceof Float)
        {
            ...
            ByteBuffer bb = BitTorrentProtocol.DEFAULT_CHARSET.encode(tempString);

            write(baos,BitTorrentProtocol.DEFAULT_CHARSET.encode(String.valueOf(bb.limit())));
                ...
                if (value != null)
                {
                    ...
                    else
                    {
                        ...
                        if (byte_keys)
                        {
                            try
                            {
                                encode(baos, BitTorrentProtocol.BYTE_CHARSET.encode(key));
        ...
        else if (object instanceof Long)
        {
            ...
            baos.write('i');
            write(baos, BitTorrentProtocol.DEFAULT_CHARSET.encode(tempLong.toString()));
            baos.write('e');
        }
        else if (object instanceof Integer)
        {
            ...
            baos.write('i');
            write(baos, BitTorrentProtocol.DEFAULT_CHARSET.encode(tempInteger.toString()));
            baos.write('e');
        ...
        else if (object instanceof byte[])
        {
            ...
            write(baos,BitTorrentProtocol.DEFAULT_CHARSET.encode(String.valueOf(tempByteArray.length)));
            baos.write(':');
